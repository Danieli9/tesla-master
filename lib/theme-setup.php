...
function tesla_scripts() {
	wp_enqueue_style( 'tesla', get_template_directory_uri() . '/dist/css/theme.min.css', '', '1.3.10' );
	wp_enqueue_script( 'tesla', get_template_directory_uri() . '/dist/js/scripts.min.js', array( 'jquery' ), '1.3.10', false );
